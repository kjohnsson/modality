...
print "h_crit_scale_factor(0.05, 'normal',lower_lambda = 1.109375,  upper_lambda = 1.140625) = {}".format(h_crit_scale_factor(0.05, 'normal', lower_lambda=1.109375, upper_lambda=1.140625))
