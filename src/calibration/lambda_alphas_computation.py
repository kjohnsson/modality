...
print "h_crit_scale_factor(0.05, 'shoulder', lower_lambda=1.03125, upper_lambda=1.0625) = {}".format(h_crit_scale_factor(0.05, 'shoulder', lower_lambda=1.03125, upper_lambda=1.0625))
